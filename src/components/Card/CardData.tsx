...
export default function CardData(props: CardData) {
  ...
  return (
    <div className="w-fit mx-auto">
      <div 
        className={`px-6 flex items-start justify-between py-4 ${props.show?'opacity-100':'opacity-0'} transition-all`}>
      ...
      {props.loading?
        ...
        <form 
          ...
          className='flex gap-2 justify-around items-center w-full bg-neutral-300 p-2 rounded-md mx-auto text-neutral-600'
        >
